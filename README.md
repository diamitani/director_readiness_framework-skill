...
**Source:** director-readiness-framework.md
...
1. Clone this repository:
   ```bash
   git clone https://github.com/diamitani/director_readiness_framework-skill.git
   ```
...
2. Import the skill into your agent framework:
   ...
   # For Hermes Agent
   skill_view(name='director_readiness_framework')
   ```
